...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-red">
	<div class="w3-display-middle">
	    <h1 class="w3-short w3-animate-top w3-center">Elenco do ${time.nome}</h1>
	    <hr class="w3-border-grey" style="margin:auto;width:40%">    
	    
	   
			
			<table class = "w3-table w3-striped w3-responsive w3-text-red">
	
				<c:forEach var="jogador" items="${listJogadoresTime}">
					<tr>
						<td>${jogador.nome}</td>
						<td>${jogador.idade} anos </td>		
