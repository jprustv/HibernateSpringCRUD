...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-green">
	...
	<div class="w3-display-middle">
	    <h1 class="w3-jumbo w3-animate-top w3-center">JOGADORES</h1>
	    <hr class="w3-border-grey" style="margin:auto;width:40%">    
	    
	   
			
			<table class = "w3-table w3-striped w3-responsive w3-text-green w3-center">
	
				<c:forEach var="jogador" items="${listJogador}">
					<tr>
	
						<td>${jogador.nome}</td>
						<td class = "w3-right"><a href="editJogador?id=${jogador.id}">Editar</a>
							&nbsp;&nbsp;&nbsp;&nbsp; <a
							href="deleteJogador?id=${jogador.id}">Deletar</a></td>
	
					</tr>
				</c:forEach>
			</table>
			<h4 class ="w3-text-black w3-center">
				<a href="newJogador" class = "w3-text-green">Cadastrar novo Jogador</a>
			</h4>
